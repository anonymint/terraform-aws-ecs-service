...
#####
variable "vpc_id" {
  description = "The identifier of the VPC in which to create the ALB target group."
}
...
variable "subnet_ids" {
  type        = "list"
  description = "A list of subnet IDs to attach to the ALB, it has to be on different AZ at least"
}
